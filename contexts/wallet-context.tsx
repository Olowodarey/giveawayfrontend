    ...
    try {
      ...
      try {
        ...
        if (existingWallet) {
          walletData = {
            ...
            encryptedPrivateKey:
              (existingWallet as any)?.encryptedPrivateKey || "",
            address:
              (existingWallet as any)?.accountAddress ||
              (existingWallet as any)?.address ||
      ...
      if (!walletData) {
        ...
        walletData = {
          ...
          encryptedPrivateKey:
            (walletResponse as any)?.encryptedPrivateKey || "",
          address:
            (walletResponse as any)?.accountAddress ||
            (walletResponse as any)?.address ||
            "",
        };
      }
